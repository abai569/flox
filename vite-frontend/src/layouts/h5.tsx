...

    {
      ...
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          <path d="M11.944 0A12 12 0 000 12a12 12 0 0012 12 12 12 0 0012-12A12 12 0 0012 0a12 12 0 00-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 01.171.325c.016.127.087.657.087.657l-1.004 6.142c-.138.608-.697.871-1.176.677-.985-.4-1.99-.91-2.976-1.32-.647-.27-.855-.73-.16-1.284l3.046-2.87c.26-.238.055-.388-.172-.262l-4.08 2.631c-.513.327-.969.34-1.422-.062l-1.4-1.137c-.437-.355-.437-.71.13-.99l6.945-3.2c.289-.134.646-.084.828.143z"/>
        </svg>
      ),
    },
    {
        ...
        <nav className="flex-1 px-3 py-4 overflow-y-auto">
          <ul className="space-y-1">
            {filteredMenuItems.map((item) => {
              ...
              const isBlocked = isRestrictedBlocked;
