...
export default function UserPage() {
  ...
  const handleEdit = async (user: User) => {
    ...
    setUserForm({
      ...
      autoBuyTrafficThreshold: Number(
        (user as any).autoBuyTrafficThreshold ?? 10,
      ),
  ...
  const handleSubmitUser = async () => {
    ...
    try {
      const submitData: any = {
        ...
        expTime: userForm.expTime instanceof Date ? userForm.expTime.getTime() : 0,
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <DatePicker
                ...
                value={timestampToCalendarDate(
                  userForm.expTime instanceof Date ? userForm.expTime.getTime() : null,
                )}
                onChange={(date) => {
