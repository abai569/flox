...
export default function AdminPlansPage() {
  ...
  const [pkgForm, setPkgForm, resetPkgDraft] =
    useLocalStorageState<PackageForm>("admin-plans-create-draft", {
      ...defaultPackageForm,
    });
  ...
  const handleDescSave = async () => {
    ...
    try {
      ...
      // 用顶层 groupId（*int64），不用 p.groupId（sql.NullInt64 对象）
      const gid = detailRes.data.groupId;
    ...
    <AnimatedPage className="px-3 lg:px-6 py-8">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mb-4">
        ...
        <div className="flex items-center gap-3">
          <Select
            ...
            //label="分组筛选"
            placeholder="全部分组"
            selectedKeys={filterGroupId !== null ? [String(filterGroupId)] : []}
            size="sm"
            variant="bordered"
          ...
          >
            {filterGroupId !== null && <SelectItem key="">全部分组</SelectItem>}
                      ...
                      (() => {
                        ...
                        return group ? (
                          <button
                            ...
                            onClick={() =>
                              setFilterGroupId(Number(item.groupId))
                            }
                          >
                            {group.name}
                          </button>
      ...
      >
        <ModalContent>
          ...
          <ModalFooter>
            <Button variant="flat" onPress={() => setDescModalOpen(false)}>
              取消
            </Button>
            <Button
              color="primary"
        ...
        <ModalContent>
          ...
          {pkgModalLoading ? (
            ...
            <ModalBody className="space-y-4">
              ...
              {(pkgForm.type === "subscription" || pkgForm.type === "traffic") && (
              ...
              <div className="flex flex-wrap gap-6">
                ...
                <div className="flex flex-col gap-1">
                  <Switch
                    isSelected={pkgForm.recommended}
                    onValueChange={(v) =>
                      setPkgForm((p) => ({ ...p, recommended: v }))
                    }
                  >
                    商店推荐
                  </Switch>
                  <span className="text-xs text-gray-400">商店推荐</span>
                </div>
              </div>
              {/* 隐藏套餐说明 */}
              {/* 
