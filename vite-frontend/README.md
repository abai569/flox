...
节点端：
```bash
curl -L https://raw.githubusercontent.com/abai569/flox/main/install.sh -o install.sh && chmod +x install.sh && ./install.sh
```
#### 默认管理员账号
...
---
#### 安装特定版本
从 [Releases](https://github.com/abai569/flox/releases) 页面复制对应版本的安装命令，脚本会自动安装该版本而非最新版。
